- [1. Personal Pronouns Subject and Object (Đại từ nhân xưng Chủ ngữ và Tân ngữ)](#1-personal-pronouns-subject-and-object-đại-từ-nhân-xưng-chủ-ngữ-và-tân-ngữ)
- [2. Reflexive Pronouns (Đại từ phản thân)](#2-reflexive-pronouns-đại-từ-phản-thân)
- [3. Demonstrative pronouns and adjectives (Đại từ chỉ định và Tính từ chỉ định)](#3-demonstrative-pronouns-and-adjectives-đại-từ-chỉ-định-và-tính-từ-chỉ-định)
- [4. Possessive pronouns and adjectives (Đại từ sở hữu và Tính từ sở hữu)](#4-possessive-pronouns-and-adjectives-đại-từ-sở-hữu-và-tính-từ-sở-hữu)
- [5. Interrogave pronouns (Đại từ nghi vấn)](#5-interrogave-pronouns-đại-từ-nghi-vấn)
- [6. Indefinite Pronouns (Đại từ bất định)](#6-indefinite-pronouns-đại-từ-bất-định)
- [7. Parts of speech (Các loại từ trong tiếng Anh)](#7-parts-of-speech-các-loại-từ-trong-tiếng-anh)
- [8. Conjunctions (Liên từ)](#8-conjunctions-liên-từ)
- [9. Articles (Mạo từ: a, an, the)](#9-articles-mạo-từ-a-an-the)
- [10. Nouns (Danh từ)](#10-nouns-danh-từ)
- [11. Countable vs Uncountable Nouns (Danh từ đếm được và không đếm được)](#11-countable-vs-uncountable-nouns-danh-từ-đếm-được-và-không-đếm-được)
- [12. Plural Nouns (Danh từ số nhiều)](#12-plural-nouns-danh-từ-số-nhiều)
...
2. Tính từ chỉ định
    <details>
    <summary>Đi trước danh từ - Phải cùng dạng số ít/nhiều với danh từ đang được nói tới</summary><p>
...
4. Cách diễn đạt `This is`
    <details>
    <summary>Cách diễn đạt này khi bạn đang nghe điện thoại hoặc bạn giới thiệu ai đó</summary><p>
...
2. Tính từ sở hữu
    <details>
    <summary>Dùng để thể hiện QUYỀN SỞ HỮU một vật hoặc trong một mối quan hệ với ai đó</summary><p>
...
1. Định nghĩa
    ...
    *Có `nhiều loại` danh từ như: Cụ thể, trừu tượng, đếm được, không đếm được...*      
